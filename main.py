...
# Define banned words
BANNED_WORDS = [
    'kiss', 'ummah', 'umma', 'gay', 'less', 'les', 
    'fuck', 'ballo', 'hukahan', 'hutto', 'kukku', 'cuccu',
    'balla', 'balli', 'kolukaraya', 'kollukaraya', 'huttige putha',
    'puka', 'hutta', 'kelahan', 'hukapan', 'ummaaaah', 'ummmmmahhhhhh',
    'ummmaaahhh', 'ummahhh'
]

# Message handler to delete banned words
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if any(word in text for word in BANNED_WORDS):
        try:
            ...
            warning_msg = f"{user_mention} (ID: {user.id})\nDon't use bad words Sattalane kiyana de ahanna!"
            await context.bot.send_message(
                chat_id=message.chat_id,
                text=warning_msg,
                parse_mode='HTML'
